...
[Rx,tau , maxlag] = autocorrelacion (Eb,M,s,L,Tb,1e5) ;
Tm = (Tb*log2(M))/L;
Fm=1/Tm;

% La transformada discreta de Fourier de Rx nos debería dar el espectro
%densidad de potencia . El intervalo de representación es [-Fm/2,Fm/2],
%medido en hertzios .
S=Tm*abs( fftshift ( fft (Rx, 4*maxlag))) ;
% Eje de frecuencias
...
% El espectro densidad de potencia realEspectro densidad de potencia de una señal digital linealmente modulada
