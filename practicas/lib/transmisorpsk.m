function [Xn,Bn,An,phi1,phi2,alfabeto] = transmisorpsk(Bn,Eb,M,s1, s2, L, offset)
%%
% [Xn,Bn,An,phi1,phi2,alfabeto] = transmisorpsk(Bn,Eb,M,s1, s2, L)
%%
...
alfabeto=sqrt(Eb*k)*exp(1i * 2 * pi * (0:1:M-1)/M + offset * 1i);
